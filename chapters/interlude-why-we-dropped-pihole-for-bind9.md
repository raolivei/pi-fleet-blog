# Interlude: Why We Dropped Pi-hole for BIND9
...
This interlude is the story of that simplification — off the main chapter timeline, but worth documenting — and why the old war stories about port 53, klipper-lb, and kube-vip still matter even after Pi-hole is gone.
...
Eldertree DNS is boring again — the best compliment infrastructure can get. The numbered chapters continue with [Chapter 2: First Boot](/chapters/02-first-boot) (first `kubectl get nodes` with all three Pis ready). This detour was worth writing down because **simplification is a design decision**, not a confession of failure.
...
*Related: [Chapter 1](/chapters/01-the-moment-i-decided-to-own-my-infrastructure) · [legacy Chapter 8 — DNS](/.archive/chapters/08-dns-service-discovery) · [legacy Chapter 14 — Troubleshooting](/.archive/chapters/14-troubleshooting)*
